const data = [
    ...
    },
    {
        "title": "horse",
        "image": "https://loremflickr.com/640/480/technics",
        "name": "Luxurious Rubber Keyboard",
        "price": "1",
        "lastPrice": "9",
        "id": "54"
    },
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        content.innerHTML += `
            <div>
                ...
                <p>Last Price: ${element.lastPrice}</p>
                <p>ID: ${element.id}</p>
            </div>
        `;
    }
